...
// TAMBAHAN: Tabel untuk menyimpan dokumen yang diunggah pasien
// dan menunggu verifikasi dokter.
// Ini jembatan antara "Upload Dokumen" pasien dan "Permintaan Verifikasi" dokter.
db.exec(`
...
`);
db.exec(`CREATE INDEX IF NOT EXISTS idx_pending_doctor ON pending_uploads (doctor_address, status);`);
db.exec(`CREATE INDEX IF NOT EXISTS idx_pending_patient ON pending_uploads (patient_address, status);`);
